...
const WEIGHTS = {
  ...
  // Moderate.
  // Canvas noise (guard 84). Deliberately NOT scored as an automation tell.
  // Per-call randomness is loud — no shipping browser does it, because it would
  // break every legitimate canvas — but seeded noise is what Brave farbling and
  // Firefox's resistFingerprinting do for millions of real people. Camoufox
  // hides in exactly that crowd, and weighting it like a bot signal would
  // block privacy-conscious humans. It is texture, not evidence.
  "canvas-noise-per-call": 25,
  "canvas-noise-seeded": 8,
  "canvas-unavailable": 6,
